          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Rejected Posts</h4>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>ABC Corp</td>
                            <td style="background-color: hsl(0, 99%, 48%); color: white; font-weight: bold;">Rejected</td>
                          </tr>
                          <tr>
                            <td>2</td>
                            <td>Graphic Designer</td>
                            <td>XYZ Designs</td>
                            <td style="background-color: rgb(244, 0, 0); color: white; font-weight: bold;">Rejected</td>
                          </tr>
